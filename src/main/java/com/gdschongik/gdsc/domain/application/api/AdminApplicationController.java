...
import com.gdschongik.gdsc.domain.application.application.AdminApplicationService;
...
public class AdminApplicationController {
    ...
    @GetMapping("/payment")
    public ResponseEntity<Page<ApplicationResponse>> getApplicationByPaymentStatus(
            ApplicationQueryOption queryOption,
            @RequestParam(name = "status", required = false) RequirementStatus paymentStatus,
            Pageable pageable) {
        Page<ApplicationResponse> response =
                applicationService.getApplicationsByPaymentStatus(queryOption, paymentStatus, pageable);
