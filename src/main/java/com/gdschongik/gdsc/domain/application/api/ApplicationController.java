...
public class ApplicationController {
    ...
    @Operation(summary = "회비 납부 상태에 따른 가입신청 전체 조회", description = "회비 납부 상태에 따른 가입신청 목록을 조회합니다.")
    @GetMapping("/payment")
    public ResponseEntity<Page<ApplicationResponse>> getMembersByPaymentStatus(
        ...
        Page<ApplicationResponse> response = applicationService.getApplicationsByPaymentStatus(paymentStatus, pageable);
